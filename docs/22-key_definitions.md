...
* *Application*: An application hosted by Smylen, either maintained and created by Smylen, or maintained and created by a Customer or Partner.

* *Application Level*: Controls and security associated with an Application. In the case of Smylen Customers, Smylen does not have access to and cannot assure compliance with security standards and policies at the Application Level.
...
* *Backup Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Smylen Add-ons and as an option for Smylen Customers.
...
* *Customers*: Contractually bound users of Smylen Platform.
...
* *Indication*: A sign that an Incident may have occurred or may be occurring at the present time. Examples of indications include:
  ...
  * Automated alerts of activity from log monitors like AWS GuardDuty;
  * An alert from GuardDuty about integrity issues.
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification to customers in the case of suspicious activity. Offered with all Smylen Add-ons and as an option for Smylen Customers.
...
* *Logging Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Smylen Add-ons and as an option for Smylen Customers.
...
* *Organization*: For the purposes of this policy, the term "organization" shall mean Smylen.

* *Partner*: Contractual bound 3rd party vendor with integration with the Smylen Platform. May offer Add-on services.

* *Platform*: The overall technical environment of Smylen.
...
* *Security Incident* (or just Incident): A security incident is an occurrence that exercises a significant adverse effect on people, process, technology, or data. Security incidents include, but are not limited to:
  ...
  * Unauthorized change or destruction of ePHI (i.e. delete dictation, data alterations not following Smylen's procedures);
...
* *Vendors*: Persons from other organizations marketing or selling products or services, or providing services to Smylen.
