...
5. All Production Data at rest is stored on encrypted volumes using encryption keys managed by Smylen. Encryption at rest is ensured through the use of automated deployment scripts referenced in the [Configuration Management Policy](09-configuration_management_policy.md#9-configuration-management-policy).
